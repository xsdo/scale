...
public class SdsWordUtil {
    ...
    public static String getDld(EisUser eisUser, EisRecord eisRecord, String templateurl) {
        ...
        String fileName=eisUser.getUserName()+"_"+eisRecord.getTableId()+filenameRandom+"_sds.docx";  // 结果文件
    ...
    public static void doParagraphs(XWPFDocument doc,EisUser eisUser,EisRecord eisRecord) {
        ...
        if(endScore>72){
            string=string+"您的抑郁情况为重度抑郁。";
        }else if(62<endScore && endScore<=72){
            string=string+"您的抑郁情况为中度抑郁。";
        }else if(53<=endScore && endScore<=62){
            string=string+"您的抑郁情况为轻度抑郁。";
        }else{
            string=string+"您的抑郁情况为正常。";
        }
        textMap.put("var", "标准分低于53分者为正常；\n" +
                "标准分为53~62分者为轻度抑郁；\n" +
                "标准分为63~72分者为中度抑郁；\n" +
                "标准分高于72分者为重度抑郁。"  +

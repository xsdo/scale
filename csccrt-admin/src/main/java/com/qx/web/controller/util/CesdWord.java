...
public class CesdWord {
    ...
    public static String getDld(ScalePatient scalePatient , ScaleTask scaleTask,String templateurl,List<ScaleScore> scaleScoreList) {
        ...
        String fileName=scalePatient.getPatientName()+"_"+scaleTask.getTestCoding()+filenameRandom+"_cesd.docx";  // 结果文件
...
//        doCharts(doc,scaleScoreList);  // 处理图表数据，柱状图、折线图、饼图啊之类的
    ...
    public static void doParagraphs(XWPFDocument doc,ScalePatient scalePatient ,ScaleTask scaleTask,List<ScaleScore> scaleScoreList) {
        ...
        for (ScaleScore scaleScore:scaleScoreList){
            ...
            if (scaleScore.getTitle().equals("1")||scaleScore.getTitle().equals("3")||scaleScore.getTitle().equals("6")
                    ||scaleScore.getTitle().equals("9")||scaleScore.getTitle().equals("10")||scaleScore.getTitle().equals("14")
                    ||scaleScore.getTitle().equals("17")||scaleScore.getTitle().equals("18")){
                scoreA=scaleScore.getScore();
            }else if (scaleScore.getTitle().equals("4")||scaleScore.getTitle().equals("8")||scaleScore.getTitle().equals("12")
                    ||scaleScore.getTitle().equals("16")){
                scoreB=scaleScore.getScore();
            }else if (scaleScore.getTitle().equals("2")||scaleScore.getTitle().equals("5")||scaleScore.getTitle().equals("7")
                    ||scaleScore.getTitle().equals("11")||scaleScore.getTitle().equals("13")||scaleScore.getTitle().equals("20")){
                scoreC=scaleScore.getScore();
            }else if (scaleScore.getTitle().equals("15")||scaleScore.getTitle().equals("19")){
        ...
        if (score<=15){
            ...
            string="您目前可能存在抑郁症状。建议做进一步的检查，可尝试做一些令你感到愉快的事儿，使身心放松。";
        }else if (score>=20){
            string="您目前存在抑郁症状。建议及时寻求心理治疗，必要时可结合药物治疗。";
        }

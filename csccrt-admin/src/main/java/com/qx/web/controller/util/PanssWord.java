...
public class PanssWord {
    ...
    public static String getDld(ScalePatient scalePatient , ScaleTask scaleTask,String templateurl,List<ScaleScore> scaleScoreList) {
        ...
        String fileName=scalePatient.getPatientName()+"_"+scaleTask.getTestCoding()+filenameRandom+"_panss.docx";  // 结果文件
    ...
    public static void doParagraphs(XWPFDocument doc,ScalePatient scalePatient ,ScaleTask scaleTask,List<ScaleScore> scaleScoreList) {
        ...
        for (ScaleScore scaleScore:scaleScoreList){
            ...
            }else if (scaleScore.getTitle().equals("15")||scaleScore.getTitle().equals("16")||scaleScore.getTitle().equals("17")
                    ||scaleScore.getTitle().equals("18")||scaleScore.getTitle().equals("19")||scaleScore.getTitle().equals("20")
                    ||scaleScore.getTitle().equals("21")||scaleScore.getTitle().equals("22")||scaleScore.getTitle().equals("23")
                    ||scaleScore.getTitle().equals("24")||scaleScore.getTitle().equals("25")||scaleScore.getTitle().equals("26")
                    ||scaleScore.getTitle().equals("27")||scaleScore.getTitle().equals("28")||scaleScore.getTitle().equals("29")
                    ||scaleScore.getTitle().equals("30")){
                scoreC+=scaleScore.getScore();
            }else if (scaleScore.getTitle().equals("31")||scaleScore.getTitle().equals("32")||scaleScore.getTitle().equals("33")){
        ...
        Long[] aa = {score1,score2,score3,score4,score5,score6};
        ...
        if (score1==aa[aa.length-1]){
            string="反应缺乏";
        }else if (score2==aa[aa.length-1]){
            string="思维障碍";
        }else if (score3==aa[aa.length-1]){
            string="激活性";
        }else if (score4==aa[aa.length-1]){
            string="偏执";
        }else if (score5==aa[aa.length-1]){
            string="抑郁";
        }else if (score6==aa[aa.length-1]){
            string="攻击性";
        }
        if (score1==aa[aa.length-2]){
            string2="反应缺乏";
        }else if (score2==aa[aa.length-2]){
            string2="思维障碍";
        }else if (score3==aa[aa.length-2]){
            string2="激活性";
        }else if (score4==aa[aa.length-2]){
            string2="偏执";
        }else if (score5==aa[aa.length-2]){
            string2="抑郁";
        }else if (score6==aa[aa.length-2]){
            string2="攻击性";
        }

        Long score =scoreA+scoreB+scoreC;
        textMap.put("varA",scoreA+"");
        textMap.put("varB",scoreB+"");
        textMap.put("varC",scoreC+"");
        textMap.put("varD",score+"");
        textMap.put("var", "本次测验显示，当前以"+str+"性症状为主，其中在"+string+"、"+string2+"症状上表现突出。");

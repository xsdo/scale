...
public class PanssWordUtil {
    ...
    public static String getDld(EisUser eisUser, EisRecord eisRecord, String templateurl) {
        ...
        String fileName=eisUser.getUserName()+"_"+eisRecord.getTableId()+filenameRandom+"_panss.docx";  // 结果文件
    ...
    public static void doParagraphs(XWPFDocument doc,EisUser eisUser,EisRecord eisRecord) {
        ...
        Map<String, String> textMap = new HashMap<String, String>();
         ...
         if(eisRecord.getScore()>120){
            ...
            textMap.put("var", "该量表主要用来判断精神症状的有无以及各种症状的严重情况，区分以阳性症状为主的I型和以阴性症状为主的II型精神分裂症。阳性量表分减去阴性量表分，正值为I型，负值为II型。总分越高，说明症状越严重。本次测量总分"+eisRecord.getScore()+"分，");

package com.qx.common.core.controller;
...
import com.qx.common.utils.sql.SqlUtil;
...
import com.qx.common.constant.HttpStatus;
import com.qx.common.core.domain.AjaxResult;
import com.qx.common.core.domain.AjaxResult.Type;
import com.qx.common.core.page.PageDomain;
import com.qx.common.core.page.TableDataInfo;
import com.qx.common.core.page.TableSupport;
import com.qx.common.utils.DateUtils;
...
public class BaseController
{
     ...
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    protected TableDataInfo getDataTable1(PageInfo<?> list)
    {
        TableDataInfo rspData = new TableDataInfo();
        rspData.setCode(HttpStatus.SUCCESS);
